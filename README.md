...
# Disclaimer
Το συγκεκριμένο παιχνίδι δημιουργήθηκε στα πλαίσια του μαθημάτος Ανάπτυξη διαδικτυακών συστημάτων και εφαρμογών του τμήματος μηχανικών πληροφορικής και ηλεκτρονικών συστημάτων του ΔΙ.ΠΑ.Ε.Δεν αποτελεί ρεαλιστική απεικόνιση αντίστοιχων σύγχρονων εφαρμογών τοσο σε εμπορικά όσο και σε προγραμματιστικά πλαίσια.Υπάρχουν κάποιες ασάφειες,λάθη και μερικά bugs στον κώδικα του παιχνιδιού άλλα τρέχει κανονικά. Αν συναντήσετε κάποια απο τις παραπάνω περιπτώσεις παρακαλώ να δείξετε κατανόηση.
# Demo Page
