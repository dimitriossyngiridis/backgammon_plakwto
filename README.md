...
# Disclaimer
Το συγκεκριμένο παιχνίδι δημιουργήθηκε στα πλαίσια του μαθημάτος Ανάπτυξη διαδικτυακών συστημάτων και εφαρμογών του τμήματος μηχανικών πληροφορικής και ηλεκτρονικών συστημάτων του ΔΙ.ΠΑ.Ε.Δεν αντικατροπτίζει ρεαλιστικές απαιτήσεις για αντίστοιχες εφαρμογές σε εμπορικά και εταιρικά πλαίσια.Υπάρχουν κάποιες ασάφειες,λάθη και μερικά bugs στον κώδικα του παιχνιδιού άλλα τρέχει κανονικά. Αν συναντήσετε κάποια απο τις παραπάνω περιπτώσεις παρακαλώ να δείξετε κατανόηση.
# Demo Page
